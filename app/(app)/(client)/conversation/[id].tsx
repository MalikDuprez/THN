// app/(app)/(client)/conversation/[id].tsx
import { 
  View, 
  Text, 
  FlatList,
...
export default function ConversationScreen() {
  ...
  const otherName = getOtherParticipantName(conversation, false); // false = client
  const otherAvatar = getOtherParticipantAvatar(conversation, false);
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        ...
        <Pressable style={styles.headerProfile}>
          ...
          <View>
            ...
            <Text style={styles.headerStatus}>Coiffeur</Text>
          </View>
        </Pressable>
